...
- Send /verify in group & wait for It To Accept Or Directly Contact To Owner After Request @Wizardd_owner.
...
Get connected channels list with - /connections"""
    ...
    ABOUT = """Developed By @Wizardd_owner

✯ Mʏ Nᴀᴍᴇ:  {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/RN_DaDa'>Puspa</a>
